 ...
 */
package eu.europa.ec.eudi.walletprovider.adapter.warden
...
class WarderAttestationVerificationService(
    private val attestationService: WardenAttestationService,
) {
    val validateKeyAttestation: ValidateKeyAttestation =
        ValidateKeyAttestation { unvalidatedKeyAttestation, challenge ->
            attestationService
